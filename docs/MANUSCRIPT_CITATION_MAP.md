...
|---|---|---|---|
| Introduction | motivation and background | `kwon2023vllm`, `yu2022orca`, `agrawal2024sarathi`, `zhong2024distserve`, `burstgpt2025`, `azure2024trace`, `servegen2026` | `docs/PROJECT_STATUS.md`, `docs/SCIENTIFIC_CAVEATS_AND_OPEN_ISSUES.md` |
| Related Work | narrow and conservative positioning | `kwon2023vllm`, `vidur2024`, `servegen2026`, `burstgpt2025`, `azure2024trace`, `tracelab2026`, `fastserve2024`, `jitserve2025`, `pars2025`, `libra2026` | `docs/literature/RELATED_WORK_POSITIONING.md`, `docs/literature/NOVELTY_THREAT_LEDGER.md` |
| Workload provenance | dataset semantics and exact trace families | `burstgpt2025`, `azure2024trace`, `tracelab2026`, `servegen2026` | `docs/literature/WORKLOAD_DATASET_LEDGER.md` |
...
| Limitations | explicit boundary and unresolved provenance | `burstgpt2025`, `azure2024trace`, `tracelab2026` and project caveat docs | `docs/SCIENTIFIC_CAVEATS_AND_OPEN_ISSUES.md` |
