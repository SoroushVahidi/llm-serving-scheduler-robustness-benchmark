...
Large language model (LLM) serving systems have grown increasingly
sophisticated in how they schedule and allocate resources to concurrent
requests. Beyond simple first-come-first-served execution, modern serving
stacks employ continuous batching and paged key-value (KV) cache management
