...
2024 LLM-inference trace \citep{stojkovic2025dynamollm}, and a Bailian/Qwen
...
additional context but are not part of the primary Pilot-V2 132-window
...
metrics, policy identities, or Stage-0 tie/non-tie outcomes
(\texttt{BURSTGPT\_OUTCOME\_TARGETING = NO}, structurally verified). Windows
...
We report the final characterization result as
\texttt{SEPARABILITY\_RESULT\_CONFIRMED\_WITH\_CAVEATS}. The safe claim
