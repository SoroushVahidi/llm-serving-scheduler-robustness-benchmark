...
specified in the protocol to test for global differences, it was not
materialized in the canonical artifacts; we disclose this as an
implementation gap and proceed directly to the pairwise tests below.
...
Pilot-V2 artifact, all $36$ records that the five-class taxonomy below
...
used throughout this test was fixed prospectively, before any Pilot-V2
reversal was observed, by reusing this project's own earlier Stage-0
discriminability criterion (\texttt{\_relative\_range\_qualifies},
