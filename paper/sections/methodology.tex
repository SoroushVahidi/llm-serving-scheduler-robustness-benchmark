...
the frozen protocol; results for the five directly computable from the six
canonical Pilot-V2 artifacts are reported in
\S\ref{sec:results-robustness} (the remaining two require per-cell data
beyond those six artifacts and are noted there as open items).
