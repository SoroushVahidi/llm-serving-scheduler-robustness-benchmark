...
transfer conclusion (\S\ref{sec:results-rq3-pilot}). Whether this
benchmark's largest identified reversal reproduces on real vLLM/GPU
execution (RQ6) remains a frozen, not-yet-executed result contract
...
those conditions explicitly rather than being read as general. We plan to
release LSSP as a public, independently reproducible artifact
