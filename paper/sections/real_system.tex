...
\begin{table}[t]
\centering
\caption{Real-vLLM RQ6 outcomes against the simulator-selected cases (\texttt{HIGH\_PRESSURE}, 40 paired windows/source, 95\% window-level bootstrap CI, $2{,}000$ resamples).}
\label{tab:rq6-results}
\begin{tabular}{lccccl}
\toprule
Source & Simulator winner & Real effect (SLAI$-$vLLM) & 95\% CI & Real winner & Agreement \\
\midrule
Azure-2024 (reversal) & SLAI ($+0.520$) & $-0.0235$ & $[-0.0266,-0.0204]$ & vLLM & Disagrees \\
BurstGPT (reversal) & vLLM ($-0.348$) & $-0.2003$ & $[-0.2638,-0.1444]$ & vLLM & Agrees \\
Bailian/Qwen (control) & n/a$^{*}$ & $-0.0256$ & $[-0.0299,-0.0219]$ & vLLM & Consistent w/ Azure \\
\bottomrule
\end{tabular}
\\[2pt]
...
between the Azure and Bailian/Qwen conditions, which it does.}
\end{table}
